...
function Slideshow(props) {
    ...
    return (
        <div className='w-full relative'>
            <a href='#precedent' className='absolute left-0 top-0 h-full flex items-center pl-10' onClick={imagePrev} onKeyDown={handleKeyDown}>
            ...
            <a href='#suivant' className='absolute right-0 top-0 h-full flex items-center pr-10' onClick={imageNext} onKeyDown={handleKeyDown}>
